...
//
// Solidity: function getStakeGovernanceConfig() view returns((uint256,uint256,uint256,uint256,uint256,uint256,bool,uint256,uint256[]))
...
//
// Solidity: function getSubnetInfo() view returns((bytes32,string,address,uint16,string,string,(uint32,uint32,uint32,uint8,uint16),(uint32,uint32,uint32,uint32),string,uint256,uint256,uint8,uint256,bool))
...
// StakeConfig is a free data retrieval call binding the contract method 0x0dedd016.
//
// Solidity: function stakeConfig() view returns(uint256 minValidatorStake, uint256 minAgentStake, uint256 minMatcherStake, uint256 maxValidators, uint256 maxAgents, uint256 maxMatchers, bool autoApprove, uint256 unstakeLockPeriod)
func (_Subnet *SubnetCaller) StakeConfig(opts *bind.CallOpts) (struct {
	MinValidatorStake *big.Int
	MinAgentStake     *big.Int
	MinMatcherStake   *big.Int
	MaxValidators     *big.Int
	...
	var out []interface{}
	err := _Subnet.contract.Call(opts, &out, "stakeConfig")
	...
	outstruct.MinValidatorStake = *abi.ConvertType(out[0], new(*big.Int)).(**big.Int)
	outstruct.MinAgentStake = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
	outstruct.MinMatcherStake = *abi.ConvertType(out[2], new(*big.Int)).(**big.Int)
	outstruct.MaxValidators = *abi.ConvertType(out[3], new(*big.Int)).(**big.Int)
	outstruct.MaxAgents = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
	outstruct.MaxMatchers = *abi.ConvertType(out[5], new(*big.Int)).(**big.Int)
	outstruct.AutoApprove = *abi.ConvertType(out[6], new(bool)).(*bool)
	outstruct.UnstakeLockPeriod = *abi.ConvertType(out[7], new(*big.Int)).(**big.Int)
...
//
// Solidity: function stakeConfig() view returns(uint256 minValidatorStake, uint256 minAgentStake, uint256 minMatcherStake, uint256 maxValidators, uint256 maxAgents, uint256 maxMatchers, bool autoApprove, uint256 unstakeLockPeriod)
func (_Subnet *SubnetSession) StakeConfig() (struct {
	MinValidatorStake *big.Int
	MinAgentStake     *big.Int
	MinMatcherStake   *big.Int
	MaxValidators     *big.Int
	...
	return _Subnet.Contract.StakeConfig(&_Subnet.CallOpts)
}

// StakeConfig is a free data retrieval call binding the contract method 0x0dedd016.
//
// Solidity: function stakeConfig() view returns(uint256 minValidatorStake, uint256 minAgentStake, uint256 minMatcherStake, uint256 maxValidators, uint256 maxAgents, uint256 maxMatchers, bool autoApprove, uint256 unstakeLockPeriod)
func (_Subnet *SubnetCallerSession) StakeConfig() (struct {
	MinValidatorStake *big.Int
	MinAgentStake     *big.Int
	MinMatcherStake   *big.Int
	MaxValidators     *big.Int
...
// Initialize is a paid mutator transaction binding the contract method 0x16272134.
//
// Solidity: function initialize((bytes32,string,address,uint16,string,string,(uint32,uint32,uint32,uint8,uint16),(uint32,uint32,uint32,uint32),string,uint256,uint256,uint8,uint256,bool) _subnetInfo, address _factory, address governance_, address stakingManager_) returns()
func (_Subnet *SubnetTransactor) Initialize(opts *bind.TransactOpts, _subnetInfo DataStructuresSubnetInfo, _factory common.Address, governance_ common.Address, stakingManager_ common.Address) (*types.Transaction, error) {
	return _Subnet.contract.Transact(opts, "initialize", _subnetInfo, _factory, governance_, stakingManager_)
}

// Initialize is a paid mutator transaction binding the contract method 0x16272134.
//
// Solidity: function initialize((bytes32,string,address,uint16,string,string,(uint32,uint32,uint32,uint8,uint16),(uint32,uint32,uint32,uint32),string,uint256,uint256,uint8,uint256,bool) _subnetInfo, address _factory, address governance_, address stakingManager_) returns()
func (_Subnet *SubnetSession) Initialize(_subnetInfo DataStructuresSubnetInfo, _factory common.Address, governance_ common.Address, stakingManager_ common.Address) (*types.Transaction, error) {
	return _Subnet.Contract.Initialize(&_Subnet.TransactOpts, _subnetInfo, _factory, governance_, stakingManager_)
}

// Initialize is a paid mutator transaction binding the contract method 0x16272134.
//
// Solidity: function initialize((bytes32,string,address,uint16,string,string,(uint32,uint32,uint32,uint8,uint16),(uint32,uint32,uint32,uint32),string,uint256,uint256,uint8,uint256,bool) _subnetInfo, address _factory, address governance_, address stakingManager_) returns()
func (_Subnet *SubnetTransactorSession) Initialize(_subnetInfo DataStructuresSubnetInfo, _factory common.Address, governance_ common.Address, stakingManager_ common.Address) (*types.Transaction, error) {
	return _Subnet.Contract.Initialize(&_Subnet.TransactOpts, _subnetInfo, _factory, governance_, stakingManager_)
}
...
// SetStakeConfig is a paid mutator transaction binding the contract method 0x9ba0cc25.
//
// Solidity: function setStakeConfig((uint256,uint256,uint256,uint256,uint256,uint256,bool,uint256,uint256[]) _stakeConfig) returns()
