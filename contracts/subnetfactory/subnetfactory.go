...
type DataStructuresCheckpointPolicy struct {
	...
	MinEpochInterval  uint32
	MaxEpochInterval  uint32
	MinValidatorCount uint8
	ThresholdPercent  uint16
}
...
//
// Solidity: function getAllSubnetInfo() view returns((bytes32,string,address,uint16,string,string,(uint32,uint32,uint32,uint8,uint16),(uint32,uint32,uint32,uint32),string,uint256,uint256,uint8,uint256,bool)[] infos, uint256[] validator_counts, uint256[] agent_counts, uint8[] statuses)
...
//
// Solidity: function getSubnetInfo(bytes32 subnet_id) view returns((bytes32,string,address,uint16,string,string,(uint32,uint32,uint32,uint8,uint16),(uint32,uint32,uint32,uint32),string,uint256,uint256,uint8,uint256,bool) info, uint256 validator_count, uint256 agent_count, uint8 subnet_status)
...
//
// Solidity: function getSubnetStakeConfig(bytes32 subnet_id) view returns((uint256,uint256,uint256,uint256,uint256,uint256,bool,uint256,uint256[]) config)
...
//
// Solidity: function getSubnetThreshold(bytes32 subnet_id) view returns((uint32,uint32,uint32,uint32) threshold)
...
func (_SubnetFactory *SubnetFactoryCaller) Governance(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SubnetFactory.contract.Call(opts, &out, "governance")
...
//
// Solidity: function governance() view returns(address)
func (_SubnetFactory *SubnetFactorySession) Governance() (common.Address, error) {
	return _SubnetFactory.Contract.Governance(&_SubnetFactory.CallOpts)
}

// Governance is a free data retrieval call binding the contract method 0x5aa6e675.
//
// Solidity: function governance() view returns(address)
func (_SubnetFactory *SubnetFactoryCallerSession) Governance() (common.Address, error) {
	return _SubnetFactory.Contract.Governance(&_SubnetFactory.CallOpts)
}
...
// CreateSubnet is a paid mutator transaction binding the contract method 0x6d1ba207.
//
// Solidity: function createSubnet((string,address,uint16,string,string,(uint32,uint32,uint32,uint8,uint16),(uint32,uint32,uint32,uint32),string,uint256,bool) create_info, (uint256,uint256,uint256,uint256,uint256,uint256,bool,uint256,uint256[]) stake_config) payable returns(address, bytes32)
func (_SubnetFactory *SubnetFactoryTransactor) CreateSubnet(opts *bind.TransactOpts, create_info DataStructuresCreateSubnetInfo, stake_config DataStructuresStakeGovernanceConfig) (*types.Transaction, error) {
	return _SubnetFactory.contract.Transact(opts, "createSubnet", create_info, stake_config)
}

// CreateSubnet is a paid mutator transaction binding the contract method 0x6d1ba207.
//
// Solidity: function createSubnet((string,address,uint16,string,string,(uint32,uint32,uint32,uint8,uint16),(uint32,uint32,uint32,uint32),string,uint256,bool) create_info, (uint256,uint256,uint256,uint256,uint256,uint256,bool,uint256,uint256[]) stake_config) payable returns(address, bytes32)
func (_SubnetFactory *SubnetFactorySession) CreateSubnet(create_info DataStructuresCreateSubnetInfo, stake_config DataStructuresStakeGovernanceConfig) (*types.Transaction, error) {
	return _SubnetFactory.Contract.CreateSubnet(&_SubnetFactory.TransactOpts, create_info, stake_config)
}

// CreateSubnet is a paid mutator transaction binding the contract method 0x6d1ba207.
//
// Solidity: function createSubnet((string,address,uint16,string,string,(uint32,uint32,uint32,uint8,uint16),(uint32,uint32,uint32,uint32),string,uint256,bool) create_info, (uint256,uint256,uint256,uint256,uint256,uint256,bool,uint256,uint256[]) stake_config) payable returns(address, bytes32)
func (_SubnetFactory *SubnetFactoryTransactorSession) CreateSubnet(create_info DataStructuresCreateSubnetInfo, stake_config DataStructuresStakeGovernanceConfig) (*types.Transaction, error) {
	return _SubnetFactory.Contract.CreateSubnet(&_SubnetFactory.TransactOpts, create_info, stake_config)
}
...
//
// Solidity: function initialize(address _guardian, address _governance, address _subnetImplementation) returns()
func (_SubnetFactory *SubnetFactoryTransactor) Initialize(opts *bind.TransactOpts, _guardian common.Address, _governance common.Address, _subnetImplementation common.Address) (*types.Transaction, error) {
	return _SubnetFactory.contract.Transact(opts, "initialize", _guardian, _governance, _subnetImplementation)
}

// Initialize is a paid mutator transaction binding the contract method 0xc0c53b8b.
//
// Solidity: function initialize(address _guardian, address _governance, address _subnetImplementation) returns()
func (_SubnetFactory *SubnetFactorySession) Initialize(_guardian common.Address, _governance common.Address, _subnetImplementation common.Address) (*types.Transaction, error) {
	return _SubnetFactory.Contract.Initialize(&_SubnetFactory.TransactOpts, _guardian, _governance, _subnetImplementation)
}

// Initialize is a paid mutator transaction binding the contract method 0xc0c53b8b.
//
// Solidity: function initialize(address _guardian, address _governance, address _subnetImplementation) returns()
func (_SubnetFactory *SubnetFactoryTransactorSession) Initialize(_guardian common.Address, _governance common.Address, _subnetImplementation common.Address) (*types.Transaction, error) {
	return _SubnetFactory.Contract.Initialize(&_SubnetFactory.TransactOpts, _guardian, _governance, _subnetImplementation)
}
